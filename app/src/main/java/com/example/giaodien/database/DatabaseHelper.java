...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public List<Expense> getAllExpenses() {
        ...
        try (Cursor cursor = db.query(TABLE_EXPENSES,
                new String[]{COLUMN_EXPENSE_ID, COLUMN_AMOUNT, COLUMN_CATEGORY, COLUMN_PAYMENT_METHOD,
    ...
    public List<Expense> getRecentExpenses(int limit) {
        ...
        try (Cursor cursor = db.query(TABLE_EXPENSES,
                new String[]{COLUMN_EXPENSE_ID, COLUMN_AMOUNT, COLUMN_CATEGORY, COLUMN_PAYMENT_METHOD,
                        COLUMN_DESCRIPTION, COLUMN_DATE},
                null, null, null, null, COLUMN_DATE + " DESC", String.valueOf(limit))) {
    ...
    public List<Expense> getExpensesByUser(long userId) {
        ...
        try (Cursor cursor = db.query(TABLE_EXPENSES,
                new String[]{COLUMN_EXPENSE_ID, COLUMN_AMOUNT, COLUMN_CATEGORY, COLUMN_PAYMENT_METHOD,
                        COLUMN_DESCRIPTION, COLUMN_DATE},
                COLUMN_USER_FK + " = ?", new String[]{String.valueOf(userId)},
            ...
            Log.e(TAG, "Error getting expenses by user", e);
        } finally {
            db.close();
        }
        return expenses;
    ...
    public Cursor getUserInfoByEmail(String email) {
        SQLiteDatabase db = this.getReadableDatabase();
        return db.rawQuery("SELECT full_name, email FROM " + TABLE_USERS + " WHERE email = ?", new String[]{email});
    }
