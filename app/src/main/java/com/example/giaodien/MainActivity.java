...
public class MainActivity extends AppCompatActivity {
    ...
    private void showUserInfoDialog() {
        ...
        LinearLayout btnClearData = dialog.findViewById(R.id.btnClearData);
        LinearLayout btnDeleteAccount = dialog.findViewById(R.id.btnDeleteAccount);
        ...
        btnDeleteAccount.setOnClickListener(v -> {
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("Xoá", (dialogInterface, i) -> {
                        preferences.edit().clear().apply();
                        dbHelper.deleteUserByEmail(username); // Đảm bảo bạn có hàm này trong dbHelper
                        Intent intent = new Intent(MainActivity.this, LoginActivity.class);
                        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                        startActivity(intent);
                        dialog.dismiss();
    ...
    public static class ViewPagerAdapter extends androidx.viewpager2.adapter.FragmentStateAdapter {
        ...
        public androidx.fragment.app.Fragment createFragment(int position) {
            switch (position) {
                ...
                default:
                    return new ChiTieuFragment(); // Thay bằng fragment phù hợp nếu có
            }
        }
